...
def create_collage_for_video(matching_scenes, scenes_dir):
    # Open all the images from the matching scenes
    images = [
    Image.open(os.path.join(scenes_dir, os.path.basename(f"scene_{i}"))) for i in matching_scenes
    ]
...
def create_collage_for_images(matching_scenes, scenes_dir):
    # Open all the images from the matching scenes
    images = [
